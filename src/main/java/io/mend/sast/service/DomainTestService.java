...
import io.mend.sast.exception.UnableToTestDomainException;
...
public class DomainTestService {
  ...
  public String testDomain(String domainName) throws Exception {
    ...
    try {
      ...
      Process process = Runtime.getRuntime().exec(new String[] {"sh", "-c", "ping -c 1 " + domainName}); // SINK
